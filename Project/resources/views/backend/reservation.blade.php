                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select class="form-control" id="room_type"  required data-error="Select Room Type">
                                    ...
                                    @foreach ($room1 as $room1)
                                        ...
                                        <option id="room_type"  data-id="123">{{ $room1['room_type'] }}</option>
                                    @endforeach
                                </select>
...
{{--                                <select class="form-control" id="room_no"  required data-error="Select Room No">--}}
{{--                                    @foreach ($room1 as $room1)--}}
{{--                                        <option id="room_no"  data-id="123">{{ $room1['room_no'] }}</option>--}}
{{--                                    @endforeach--}}
{{--                                </select>--}}
{{--                                <input class="form-control" placeholder="Please Click This Room Type Button"
id="room_no" data-error="Room Type" required>--}}
{{--                                <div class="help-block with-errors"></div>--}}
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control"
                                       placeholder="dd/mm/yyyy"  id="check_in_date"
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control"
                                       placeholder="dd/mm/yyyy" id="check_out_date"
                        ...
                        <div class="panel-body">
                            <div class="form-group col-lg-6">
                                ...
                                <input class="form-control"
                                       ...
                                       data-error="Enter First Name" name="first_name">
                                <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="number" class="form-control"
                                       data-error="Enter Min 10 Digit" data-minlength="10"
                                       placeholder="Contact No" id="contact_no" name="contact_no">
                                <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="email" class="form-control"
                                       ...
                                       data-error="Enter Valid Email Address" name="email">
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group col-lg-6">
                                <label for="id_card_id">ID Card Type</label>
                                {{-- <select class="form-control" id="id_card_id"
                                data-error="Select ID Card Type" required >
                                ...
                                <select class="form-control" id="id_card_id"  required data-error="Select Room Type">
                                    ...
                                    @foreach ($card_type as $card_type)

                                        <option id="id_card_id"  data-id="123">{{ $card_type['card_name'] }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-lg-6">
                                <label for="id_card_no">Selected ID Card Number</label>
                                <input type="number" class="form-control"
                                       placeholder="ID Card Number" id="id_card_no"
                                       data-error="Enter Valid ID Card No" name="id_card_no">
                                <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <input type="text" class="form-control"
                                       placeholder="Full Address" id="address" name="address">
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group col-lg-12">
                                <h3 class=" p-3" style="color: rgb(255, 0, 0)">If you want to stay at our hotel,
                                    you need to make some payment in advance</h3>
                                    <h4 class=""><span style="color: rgb(255, 0, 0)">
                                            <i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i></span>
                                        <span style="color: rgb(0, 0, 0)"> The rest of the money should be paid
                                            at the time of leaving the hotel</span>
                                        <span style="color: rgb(255, 0, 0)"><i class="fa-solid fa-star"></i>
                                            <i class="fa-solid fa-star"></i></span></h4>
                                <h5>Advance Payment</h5>
                                <label for="payment">Total TK</label>
                                <input type="number" class="form-control "
                                       placeholder="Total Tk" id="payment" name="payment">
                                <div class="help-block with-errors"></div>

                                <label for="transaction">Enter Transaction Number</label>
                                <input type="number" class="form-control"
                                       placeholder="Transaction Number" id="transaction" name="transaction">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    </div>
                    <button type="button"
                            class="reservation btn btn-lg btn-success pull-right">Submit</button>
                </div>
            </form>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert bg-success alert-dismissable"
                             role="alert"><em class="fa fa-lg fa-check-circle">&nbsp;</em>Room Successfully Booked</div>
                        <table class="table table-striped table-bordered table-responsive">
                            <caption>A table displaying hotel reservation details</caption>
                            <thead>
                            <tr>
                                <th>Attribute</th>
                                <th>Value</th>
