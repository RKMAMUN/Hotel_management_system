                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    {{--                                    @foreach ($room1 as $room1)--}}
                                    {{--                                        <option id="room_no"
                                    data-id="123">{{ $room1['room_no'] }}</option>--}}
                                    {{--                                    @endforeach--}}
                                    {{--                                </select>--}}
                                    {{--                                <input class="form-control"
                                    placeholder="Please Click This Room Type Button" id="room_no"
                                    data-error="Room Type" required>--}}
                            ...
                            <div class="panel-body">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input class="form-control" name="first_name"
                                           placeholder="First Name" id="first_name" data-error="Enter First Name">
                                    <div class="help-block with-errors"></div>
                                </div>
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <select class="form-control" id="id_card_id"
                                        ...
                                        @foreach ($card_type as $card_type)
                                            ...
                                            <option id="id_card_id"
                                                    data-id="123">{{ $card_type['card_name'] }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="number" class="form-control"
                                           placeholder="ID Card Number" name="id_card_no"
                                           id="id_card_no" data-error="Enter Valid ID Card No" >
                                    <div class="help-block with-errors"></div>
                                </div>
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <h4 class=""><span style="color: rgb(255, 0, 0)"><i class="fa-solid fa-star">

                                            </i><i class="fa-solid fa-star"></i></span>
                                        <span style="color: rgb(0, 0, 0)"> The rest of the money
                                            should be paid at the time of leaving the hotel</span>
                                        <span style="color: rgb(255, 0, 0)"><i class="fa-solid fa-star">

                                            </i> <i class="fa-solid fa-star"></i></span></h4>
                                    <h5>Advance Payment</h5>
                                    <label for="payment">Total TK</label>
                                    <input type="number" class="form-control"
                                           name="payment" placeholder="Total Tk" id="payment">
                                    <div class="help-block with-errors"></div>

                                    <label for="transaction">Enter Transaction Number</label>
                                    <input type="number" class="form-control"
                                           placeholder="Transaction Number" name="transaction" id="transaction">
                                    <div class="help-block with-errors"></div>
                                </div>
                                <button type="button"
                                        class="reservation btn btn-lg btn-success pull-right"
                                        >Submit</button>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                font-family: 'Montserrat SemiBold', sans-serif"
                   class="">Developed By Rezaul Karim Mamun</p>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="alert bg-success alert-dismissable" role="alert">
                                <em class="fa fa-lg fa-check-circle">&nbsp;</em>Room Successfully Booked</div>
                            <table class="table table-striped table-bordered table-responsive">
                                <caption>Details of Room Booking</caption>
                                <thead>
                                <tr>
                                    <th>Customer Name</th>
                                    <th>Room Type</th>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $('.reservation').click(function() {
            ...
            //console.log(RoomType+RoomNo+check_in_date+check_out_date+
            // email+first_name+last_name+contact_no+id_card_id+address+transaction+id_card_no);
