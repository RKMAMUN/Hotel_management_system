                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control" placeholder="ID Card Number" id="id_card_id" data-error="Enter Valid ID Card No" required>
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <input type="text" class="form-control " placeholder="Total Tk" id="payment" required>
                                <div class="help-block with-errors"></div>

                                <label>Enter Transaction Number</label>
                                <input type="text" class="form-control" placeholder="Transaction Number" id="transaction" required>
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\sanzid_shihab\resources\views/backend/reservation.blade.php ENDPATH**/ ?>