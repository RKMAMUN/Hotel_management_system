                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <table id="dataTable" class="table table-striped table-bordered scroll">
                                    <caption>A list of all customers and their details</caption>
                                    <thead>
                                    <tr>
...
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\New folder (3)\sanzid_shihab\resources\views/backend/payment_ok.blade.php ENDPATH**/ ?>