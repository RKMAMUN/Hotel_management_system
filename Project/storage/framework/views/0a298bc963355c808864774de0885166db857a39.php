        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Employee Details:
                    <a href="index.php?add_emp" class="btn btn-secondary pull-right"
                       style="border-radius:0%">Add Employee</a>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-warning"
                                        ...
                                        data-toggle="modal"
                                        data-target="#changeShift"
                                        data-id="" id="change_shift">Change Shift</button>
                            </td>
                            <td>

                                <button data-toggle="modal"
                                        data-target="#empDetail"
                                        data-id="" id="editEmp"
                                        class="btn btn-info" style="border-radius:60px;">
                                    <i class="fa fa-pencil"></i></button>
                                <a href='functionmis.php?empid='
                                   class="btn btn-danger" onclick="return confirm('Are you Sure?')"
                                   style="border-radius:60px;"><i
                                        class="fa fa-trash"></i></a>
                                <a href='index.php?emp_history&empid='
                                   class="btn btn-success" title="Employee Histery"
                                   style="border-radius:60px;"><i class="fa fa-eye"></i></a>
                            </td>
                        </tr>
...
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\sanzid_shihab\resources\views/backend/staff_section.blade.php ENDPATH**/ ?>
