                    ...
                    <form role="form"  data-toggle="validator" method="post" action="">
                        <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <input id="complain_name" type="text" class="form-control" placeholder="Complainant Name" name="complainant_name" required>
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group col-lg-6">
                                <label>Complaint Type</label>
                                <input id="complain_type" type="text" class="form-control" placeholder="Complaint Type" name="complaint_type" required>
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group col-lg-12">
                                <label>Please Describe Your Complaints</label>
                                <textarea id="complain" class="form-control" name="complaint" placeholder="Complaint" required></textarea>
                            </div>

                        </div>

                        <button type="button" id="complain_button" class="btn btn-lg btn-success" name="createComplaint" style="border-radius:0%">Submit</button>
                        <button type="button" id="complain_rest_button" class="btn btn-lg btn-danger" style="border-radius:0%">Reset</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%" id="dataTable">
                        <thead>
                        <tr>
                            <th>#</th>
                        ...
                        <div class="col-lg-12">
                            <h3 style="display: none!important;" class="help_id d-none"></h3>
                                <div class="form-group">
                                    ...
                                    <input id="budget" class="form-control" placeholder="Budget" name="budget" data-error="Enter Budget" required>
                                    <div class="help-block with-errors"></div>
                                </div>

                                <button id="complain_resolve_btn" class="btn btn-success pull-right">Resolve Complaint</button>
...
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\Hotel_Management_System_Client_Project\sanzid_shihab\resources\views/backend/complain.blade.php ENDPATH**/ ?>