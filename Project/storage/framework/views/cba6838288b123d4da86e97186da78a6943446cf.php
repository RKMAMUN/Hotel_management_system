                    ...
                    <div class="panel-body">
                        ...
                        <table id="dataTable" class="table table-striped table-bordered scroll">
                            ...
                            <tr>
                                ...
                                <td id="customer_payment">Advance Payment</td>
                            ...
                            if (response.status == 200) {
                                ...
                                $.each(dataJSON, function(i, item) {
                                    $('<tr>').html(
                                        ...
                                        "<td>" + dataJSON[i].advance_payment + "</td>"+
                                        "<td>" + dataJSON[i].booking_date + "</td>"+
...
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\Hotel_Management_System_Client_Project\sanzid_shihab\resources\views/backend/customer_list.blade.php ENDPATH**/ ?>