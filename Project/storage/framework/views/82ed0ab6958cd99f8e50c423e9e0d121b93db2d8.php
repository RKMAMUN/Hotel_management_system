                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select class="form-control" id="room_type"  required data-error="Select Room Type">
                                    ...
                                    <?php $__currentLoopData = $room1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <option id="room_type"
                                                data-id="123"><?php echo e($room1['room_type']); ?>
                                        </option>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group col-lg-6">
                                ...
                                <input class="form-control" placeholder="First Name" id="first_name" data-error="Enter First Name" name="first_name">
                                <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="number" class="form-control" data-error="Enter Min 10 Digit" data-minlength="10" placeholder="Contact No" id="contact_no" name="contact_no">
                                <div class="help-block with-errors"></div>
                            </div>

                            <div class="form-group col-lg-6">
                                <label>Email Address</label>
                                <input type="email" class="form-control" placeholder="Email Address" id="email" data-error="Enter Valid Email Address" name="email">
                                <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="number" class="form-control" placeholder="ID Card Number" id="id_card_no" data-error="Enter Valid ID Card No" name="id_card_no">
                                <div class="help-block with-errors"></div>
                            </div>
                            ...
                            <div class="form-group col-lg-12">
                                ...
                                <input type="number" class="form-control " placeholder="Total Tk" id="payment" name="payment">
                                <div class="help-block with-errors"></div>

                                <label>Enter Transaction Number</label>
                                <input type="number" class="form-control" placeholder="Transaction Number" id="transaction" name="transaction">
                                <div class="help-block with-errors"></div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\Hotel_Management_System_Client_Project\sanzid_shihab\resources\views/backend/reservation.blade.php ENDPATH**/ ?>
