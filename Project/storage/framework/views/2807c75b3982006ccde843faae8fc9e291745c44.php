...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
                    ...
                    <form role="form"  data-toggle="validator" method="post" action="">
                        <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <input id="complain_name" type="text"
                                       class="form-control" placeholder="Complainant Name"
                        ...
                        <button type="button" id="complain_button"
                                class="btn btn-lg btn-success" name="createComplaint"
                                style="border-radius:0">Submit</button>
                        <button type="button" id="complain_rest_button"
                                class="btn btn-lg btn-danger" style="border-radius:0">Reset</button>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-striped table-bordered table-responsive"
                           id="dataTable">
                        <caption>Complaint Management</caption>
                        <thead>
                        <tr>
                            <th>#</th>
    ...
    <div class="row">
        <div class="col-sm-12">
            <p class="back-link">Developed By Rezaul Karim Mamun</p>
        </div>
    </div>
...
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\sanzid_shihab\resources\views/backend/complain.blade.php ENDPATH**/ ?>
