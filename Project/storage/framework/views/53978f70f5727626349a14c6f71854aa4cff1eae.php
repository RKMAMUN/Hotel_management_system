                                ...
                                <form id="addRoom" data-toggle="validator" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control"
                                               placeholder="Enter Write Your Room No" name="room_no" id="room_no"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control"
                                               placeholder="Enter Write Your Room Free" name="room_free" id="room_free"
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form id="roomEditFrom" data-toggle="validator" role="form" aria-label="">
                                    <div class="edit_response"></div>
                                    <div class="form-group">
                                        <label for="edit_room_type">Room Type</label>
                                        <input type="text" class="form-control"
                                               placeholder="Room Type" id="edit_room_type"
                                               name="edit_room_type"
                                               data-error="Enter Room Type">
                                        <div class="help-block with-errors"></div>
                                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form role="form" id="advancePayment" aria-label="">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                             ...
                             <button style="background-color: red;color: white"
                                     type="button" class="check_out_clear  btn-lg p-5">Payment Clear</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    if (response.status === 200) {
                        ...
                        $.each(dataJSON, function (i, item) {
                            ...
                            $('<tr>').html(
                                ...
                                "<td><a class='CustomerView mr-1 ' style='margin-left: 6px; border-radius: 20px'  " +
                                "data-id=" + dataJSON[i].room_no +
                                " >" + view + "</a>" +
                                "<a class='roomEdit mr-1 ' style='margin-left: 6px; border-radius: 200px' data-id=" +
                                dataJSON[i].id +
                                " >" + edit + "</a>" +
...
<?php echo $__env->make('backend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel Project\Hotel_Management_System_Client_Project\sanzid_shihab\resources\views/backend/manage_room.blade.php ENDPATH**/ ?>
